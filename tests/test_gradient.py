...
class TestValueBasicOperations:
    ...
    def test_2nd_gradient_not_None(self):
        ...
        assert ddlossdb_d[b].value == 2.0 # d^2loss/db^2 = d( dloss/db )/db = d( a + 2b )/db = 2
    ...
    def test_simple_binary_operations(self, binary_operation, a_value, b_value):
        ...
        assert allclose(numeric_derivative(lambda x: binary_operation(x, b_value), a_value), dc_d[a].value)
        assert allclose(numeric_derivative(lambda x: binary_operation(a_value, x), b_value), dc_d[b].value)
    ...
    def test_simple_compound_graph(self, custom_function):
        ...
        assert allclose(numeric_derivative(partial(custom_function, b=b_value), a_value), dloss_d[a].value)
